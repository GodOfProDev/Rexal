...
namespace Rexal {
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
			...
			if (ImGui::BeginDragDropTarget())
			{
				if (const ImGuiPayload* payload = ImGui::AcceptDragDropPayload("CONTENT_BROWSER_ITEM"))
				{
					...
					if (texture->IsLoaded())
						...
						RX_WARN("Could not load texture {0}", texturePath.filename().string());
				}
		...
		DrawComponent<CircleRendererComponent>("Circle Renderer", entity, true, [](auto& component)
		{
			ImGui::ColorEdit4("Color", glm::value_ptr(component.Color));
		...
		DrawComponent<Rigidbody2DComponent>("Rigidbody 2D", entity, true, [](auto& component)
			{
		...
		DrawComponent<BoxCollider2DComponent>("Box Collider 2D", entity, true, [](auto& component)
			{
		...
		DrawComponent<CircleCollider2DComponent>("Circle Collider 2D", entity, true, [](auto& component)
			{
				ImGui::DragFloat2("Offset", glm::value_ptr(component.Offset));
